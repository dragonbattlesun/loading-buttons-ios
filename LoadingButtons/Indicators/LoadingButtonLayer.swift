...
//  TalkMeEnglish
//
//  Created by dragonbattlesun on 2024/8/29.
//
...
class LoadingButtonLayer: CALayer, CAAnimationDelegate {
    ...
    public func setRippleColor(color: UIColor,
        withRippleAlpha rippleAlpha: CGFloat = 0.08,
        withBackgroundAlpha backgroundAlpha: CGFloat = 0.08) {
            if let rippleLayer = self.rippleLayer,
               let backgroundLayer = self.backgroundLayer {
    ...
    private func setup() {
        ...
        superLayer?.zPosition = zPosition - 1
